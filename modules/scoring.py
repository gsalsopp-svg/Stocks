...
def valuation_score(c: CompanyFinancials) -> dict:
    ...
    pe_score = _tier(r["P/E Ratio"], [(10, 7), (15, 5.5), (20, 4), (25, 2.5), (35, 1)], reverse=True, none_score=2)
    ev_ebitda_score = _tier(r["EV / EBITDA"], [(6, 6), (9, 4.5), (12, 3), (16, 1.5)], reverse=True, none_score=1.5)
    ps_score = _tier(r["Price / Sales"], [(1, 6), (2, 4.5), (3, 3), (5, 1.5)], reverse=True, none_score=1.5)
    fcf_yield_score = _tier(r["FCF Yield"], [(0.08, 6), (0.05, 4.5), (0.03, 3), (0.01, 1.5)], reverse=False, none_score=0)
...
def balance_sheet_score(c: CompanyFinancials) -> dict:
    ...
    net_cash_pct = b["Net Cash / Market Cap"]
    net_cash_score = _tier(net_cash_pct, [(0.1, 10), (0, 7), (-0.2, 4), (-0.5, 2)], none_score=0, default=0)
    de_score = _tier(b["Debt / Equity"], [(0.3, 8), (0.6, 6), (1.0, 4), (2.0, 2)], reverse=True, none_score=0, default=0)
    cr_score = _tier(b["Current Ratio"], [(2.0, 7), (1.5, 5.5), (1.2, 4), (1.0, 2)], none_score=0, default=0)
